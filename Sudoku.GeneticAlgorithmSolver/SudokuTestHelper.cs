...
namespace GeneticSharp.Extensions.UnitTests.Sudoku
{
    public static class SudokuTestHelper
    {
        ...
        public static SudokuBoard CreateBoard(string sudokuString)
        {
            Console.WriteLine(sudokuString);
            return SudokuBoard.Parse(sudokuString);
        }

        public static SudokuBoard Eval(IChromosome sudokuChromosome, SudokuBoard sudokuBoard, int populationSize, double fitnessThreshold, int generationNb)
        {
